...
class RegressionConfig(BaseConfig):
    ...
    main: FrozenDict = field(default_factory=lambda: FrozenDict({
        ...
        "latent_shape": (32,),  # Latent space shape: sequence of 6 time steps with 3 features
    ...
    encoder: FrozenDict = field(default_factory=lambda: FrozenDict({
        ...
        "input_shape": (6, 3),  # Input shape: sequence of 6 time steps with 3 features (y)
        "latent_shape": (32,),  # Latent space shape: 32-dimensional latent space
    ...
    decoder: FrozenDict = field(default_factory=lambda: FrozenDict({
        ...
        "latent_shape": (32,),  # Latent shape: 32-dimensional latent space
        "output_shape": (6, 3),  # Output shape: sequence of 6 time steps with 3 features (y)
