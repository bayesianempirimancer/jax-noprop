#!/usr/bin/env python3
"""Script to test all noise schedules for Flow Matching model and find the best based on Chamfer distance."""
    ...
    if chamfer_dist is None:
        ...
        if artifacts_dir.exists():
            ...
            for dir_path in dirs:
                fm_dir = dir_path / 'flow_matching'
                results_file = fm_dir / 'training_results.pkl'
...
def main():
    ...
    print("="*60)
    print("Testing all noise schedules for Flow Matching model")
    print("="*60)
